...
function call_chatgpt_api($prompt) {
    ...
    $data = [
        ...
        'messages' => [
            ['role' => 'system', 'content' => 'Ты православный священник. Не скупись на слова. Сделай длинную и красивую молитву. Но длиной не больше 40 слов.  Напиши молитву по следующей теме:'],
